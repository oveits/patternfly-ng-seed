 ...
 * ProjectInterceptor
 *
 * Intercepts outgoing PUT requests and adds a body that the Marathon API understands
 * Intercepts incoming GET responses and extracts the project properties from the Marathon app JSON
 */
@Injectable()
export class ProjectMarathonInterceptor implements HttpInterceptor {
